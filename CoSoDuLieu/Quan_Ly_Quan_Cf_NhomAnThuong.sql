...
CREATE TABLE HOADON(
	...
	MANV VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES NHANVIEN(MANV) ON DELETE NO ACTION,
	MABAN VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES BAN(MABAN) ON DELETE NO ACTION,
...
CREATE TABLE HOADONCHITIET(
	...
	CONSTRAINT FK_HDCT_SP FOREIGN KEY (MASP) REFERENCES SANPHAM(MASP) ON DELETE NO ACTION
)
...
INSERT INTO NHANVIEN(MANV, TENNV, NGAYSINH, GIOITINH, DIACHI, DIENTHOAI, MATKHAU, LUONGCOBAN, QUYEN)
VALUES ('NV0002', N'VŨ THỊ THƯƠNG', '12/01/1997', N'Nữ', 'Thanh An, Gia Lai', '01686276171', '1', '4500000', N'QUẢN LÝ')
INSERT INTO NHANVIEN(MANV, TENNV, NGAYSINH, GIOITINH, DIACHI, DIENTHOAI, MATKHAU, LUONGCOBAN, QUYEN)
VALUES ('NV0003', N'HUỲNH PHƯƠNG NGỌC', '09/08/1997', N'Nữ', 'Nha Trang, Khánh Hòa', '01663450987', '1', '4500000', N'NHÂN VIÊN')
INSERT INTO NHANVIEN(MANV, TENNV, NGAYSINH, GIOITINH, DIACHI, DIENTHOAI, MATKHAU, LUONGCOBAN, QUYEN)
VALUES ('NV0004', N'NGUYỄN THỊ NGÂN', '03/12/1997', N'Nữ', 'Nha Trang, Khánh Hòa', '0972456722', '1', '6000000', 'NHÂN VIÊN')
INSERT INTO NHANVIEN(MANV, TENNV, NGAYSINH, GIOITINH, DIACHI, DIENTHOAI, MATKHAU, LUONGCOBAN, QUYEN)
VALUES ('NV0005', N'LÊ MINH QUANG', '06/22/1997', N'Nam', 'Nha Trang, Khánh Hòa', '0122356321', '1', '3000000', N'NHÂN VIÊN')
